...
import { biStnbmTxHeadCells } from '@/utils/fsms/ilp/headCells'
...
const TrPage = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const endpoint: string =
        '/ilp/bi/tx/getAllBsnesMng' + toQueryParameter(searchObj)
  ...
  const excelDownload = async () => {
    ...
    try {
      ...
      const endpoint: string =
        '/ilp/bi/tx/getExcelBsnesMng' + toQueryParameter(params)
      await  getExcelFile(endpoint, '사업자정보_택시_' + getToday() + '.xlsx')
    } catch (error) {
  ...
  return (
    <Box>
      ...
      <Box>
        <TableDataGrid
          headCells={biStnbmTxHeadCells} // 테이블 헤더 값
          rows={rows} // 목록 데이터
