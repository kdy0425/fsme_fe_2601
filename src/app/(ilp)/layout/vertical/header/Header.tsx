            ...
            <>
              ...
              <Stack spacing={1} className="global-link-wrapper">
                ...
                >
                  <button type="button" className="top-btn btn-blue-contain">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M10.5 14.5C11.6667 14.3333 13.5 13.5 13.5 11"
                        stroke="white"
                        stroke-width="1.8"
                        stroke-linecap="round"
                      />
                ...
                <span className="username-zone">
                  <span className="username" style={{ color: '#1694B1' }}>
                    {authStatus.userNm}
                  </span>
                  님이 로그인하셨습니다.
                </span>
