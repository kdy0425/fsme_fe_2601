...
const DataList = () => {
  ...
  const fetchData = async () => {
    ...
    if (searchValidation()) {
      ...
      try {
        ...
        const endpoint = '/fsm/sup/iid/cm/getAllIndvInfoDownload' + toQueryParameter(searchObj)
  ...
  const excelDownload = async (): Promise<void> => {
    ...
    if (rows.length === 0) {
      ...
      const endpoint = `/fsm/sup/iid/cm/getExcelIndvInfoDownload` + toQueryParameter(searchObj)
