...
const OptAmtComponent = () => {
  ...
  return (
    <PageContainer title="대시보드 유가보조금" description="대시보조금">
      {/* 상단: 제목/기간 + 출력 */}
          ...
          {loading ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                />
                <Tooltip
                  formatter={(v: number, name: string) => [`${fmtK(v)} 천원`, name]}
...
export default OptAmtComponent
