...
const INST_CD = 'ICT' // 포털시스템 연계 송수신정보
...
const DataList = () => {
  ...
  return (
    <PageContainer
      title="포털시스템 연계 송수신정보"
      description="포털시스템 연계 송수신정보"
    >
      <Breadcrumb title="포털시스템 연계 송수신정보" items={BCrumb} />
