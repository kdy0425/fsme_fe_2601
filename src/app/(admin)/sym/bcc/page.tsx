...
import { symBccHC as baseHC } from '@/utils/fsms/headCells'

const BCrumb = [
  { to: '/', title: 'Home' },
  { title: '시스템관리' },
  { title: '연계정보관리' },
  { to: '/sym/bcc', title: '버스 카드협약사 연계관리' },
]
...
const DataList = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const endpoint = '/fsm/sym/bcc/bs/getAllBusCardCntc' + toQueryParameter(searchObj)
  ...
  const handleActionClick = useCallback(async (row: Row, id: string) => {
    ...
    const endpoint = '/fsm/sym/bcc/bs/excuteBusCardCntc'
    const body = {
      procNm: row.procNm
    }
  ...
  const excelDownload = async () => {
    ...
    const endpoint = '/fsm/sym/bcc/bs/getExcelBusCardCntc' + toQueryParameter(searchObj)
  ...
  const handleReport = async (start: string, end: string) => {
    ...
    const endpoint = '/fsm/sym/bcc/bs/getPrintBusCardCntc' + toQueryParameter(searchObj)
  ...
  return (
    <PageContainer title="버스 카드협약사 연계관리" description="버스 카드협약사 연계관리">
